...
class IAMControllerTest {
    ...
    private TokenResponse refreshedTokenResponse;
    ...
    void setUp() {
        ...
        validRegistrationRequest = new ResidentOnboardingRequest(
                "09012006030",
                "vincent@example.com",
                "Vincent",
                "Enwere",
        ...
        registrationResponse = new ResidentOnboardingResponse(
        ...
        refreshedTokenResponse = new TokenResponse(
                "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.new-access-token",
                "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.new-refresh-token",
                "Bearer",
                "profile"
        ...
        // Password setup
        validPasswordRequest = new PasswordRequest(
                "NewSecurePass123!",
                "683127b5-4432-418c-962b-97c3ea5bfe23",
        ...
        public SecurityFilterChain testSecurityFilterChain(HttpSecurity http) throws Exception {
            http
                    ...
                    .authorizeHttpRequests(auth -> auth
                            .anyRequest().permitAll()    // ← permit all in tests
                    );
            return http.build();
        }
    }
