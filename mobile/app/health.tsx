...
export default function HealthScreen() {
  const { data, isLoading, isFetching, error, refetch } = useApiHealth();
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Checks connectivity to the backend.</Text>
      ...
      {data?.ok && data.version && (
        <View style={styles.card}>
          ...
          <Text style={styles.value}>{data.version.service}</Text>

          <Text style={styles.label}>Version</Text>
          <Text style={styles.value}>{data.version.version}</Text>

          <Text style={styles.label}>Time</Text>
          <Text style={styles.value}>{data.version.time}</Text>
        </View>
      )}
      ...
      {errMsg && (
        <View style={[styles.card, styles.errorCard]}>
          ...
          <Text style={styles.errorText}>{String(errMsg)}</Text>
